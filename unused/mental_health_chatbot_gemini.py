"""
Mental Health Chatbot RAG - Main Chatbot Application (Google Gemini Version)
...
Required packages:
pip install pinecone-client google-generativeai python-dotenv requests
...
class MentalHealthChatbot:
    def __init__(self):
        ...
        if not all([self.pinecone_api_key, self.google_api_key, self.openrouter_api_key]):
        ...
        # Options: "anthropic/claude-3.5-sonnet", "openai/gpt-4", "google/gemini-pro-1.5", etc.
    ...
    def retrieve_context(self, query, top_k=3):
        ...
        try:
            ...
            for match in results['matches']:
                if match['score'] > 0.5:  # Adjusted threshold for Gemini embeddings
